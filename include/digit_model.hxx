...
// SpatialInertia get_spI_from_xml(tinyxml2::XMLElement* body_xml){
//     SpatialInertia spI;
//     auto inertial_xml = body_xml->FirstChildElement("inertial");
//     std::cout<<str2vec(inertial_xml->Attribute("pos"))<<std::endl;   
//     myfloat mass = str2f(inertial_xml->Attribute("mass"));
//     Eigen::Matrix<myfloat,3,1> com_pos = str2vec(inertial_xml->Attribute("pos"));
//     Eigen::Matrix<myfloat,3,3> I = full_inertia_from_6_elements(str2vec(inertial_xml->Attribute("fullinertia")));
//     spI = SpatialInertia(mass, com_pos, I);
//     return spI;
// }

// Joint get_hinge_from_xml(tinyxml2::XMLElement* joint_xml,tinyxml2::XMLElement* actuator_xml, myint parent_body = 0) {
//     Joint joint;
//     joint.name = joint_xml->Attribute("name");
//     joint.parent_body = parent_body;
//     joint.joint_type = JointType::REVOLUTE;
//     joint.joint_axis = str2vec(joint_xml->Attribute("axis"));
//     joint.limits = str2vec(joint_xml->Attribute("range")).transpose()*M_PI/180.0;
//     std::cout<< actuator_xml->FindAttribute("motor")->Name() << std::endl;
//     return joint;
// }
...
class DigitModel: public RigidBodyTree
{
    ...
    DigitModel() : RigidBodyTree(){
        ...
        base.parent = 0;
        base.id = num_bodies;
        base.joint.name = "free";
        base.joint.joint_type = JointType::FLOATING;
        base.joint.parent_body = base.id;
        base.joint.limits.resize(7,2);
        base.joint.limits << -MYINF, MYINF,
                            -MYINF, MYINF,
                            -MYINF, MYINF,
                            -1.0, 1.0,
                            -1.0, 1.0,
        ...
        base.spI = SpatialInertia(15.028392, Eigen::Matrix<myfloat,3,1>(0.001636612541, 0.0002001180789, 0.2593064529), Eigen::Matrix<myfloat,6,1>(0.3759052548, 0.3441935, 0.09873232746, -8.776732849e-05, 0.008498611229, 6.621611757e-05));
        base.Xtree = PluckerTransform(Eigen::Matrix<myfloat,3,1>(0.0, 0.0, 0.0), Eigen::Matrix<myfloat,3,1>(0.0, 0.0, 0.0));

        // left-hip-roll
        num_bodies++;
        RigidBody left_hip_roll;
        left_hip_roll.name = "left-hip-roll";
        left_hip_roll.parent = base.id;
        left_hip_roll.id = num_bodies;
        ...
        left_heel_spring.id = num_bodies;
        ...
        left_shoulder_roll.parent = base.id;
        left_shoulder_roll.id = num_bodies;
        ...
        left_shoulder_pitch.id = num_bodies;
        ...
        left_shoulder_yaw.id = num_bodies;
        ...
        right_hip_roll.parent = base.id;
        right_hip_roll.id = num_bodies;
        ...
        right_heel_spring.id = num_bodies;
        ...
        right_shoulder_roll.parent = base.id;
        right_shoulder_roll.id = num_bodies;
        ...
        right_shoulder_pitch.id = num_bodies;
        ...
        right_shoulder_yaw.id = num_bodies;
        ...
        Site imu;
        imu.name = "imu";
        imu.parent_body = base.id;
        imu.Xtree = PluckerTransform(Eigen::Matrix<myfloat,3,1>(0, 0, 0), Eigen::Matrix<myfloat,3,1>(0, 0, 0.4));
        ...
        std::cout<< right_toe_A.parent <<std::endl;
