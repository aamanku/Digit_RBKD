...
DigitModel::DigitModel()
    ...
    bodies.at(DigitBodyIdx::base_trans_id) = base_trans;
    bodies.at(DigitBodyIdx::base_rot_id) = base_rot;
    bodies.at(DigitBodyIdx::left_hip_roll_id) = left_hip_roll;
    bodies.at(DigitBodyIdx::left_hip_yaw_id) = left_hip_yaw;
    bodies.at(DigitBodyIdx::left_hip_pitch_id) = left_hip_pitch;
    bodies.at(DigitBodyIdx::left_knee_id) = left_knee;
    bodies.at(DigitBodyIdx::left_shin_id) = left_shin;
    bodies.at(DigitBodyIdx::left_tarsus_id) = left_tarsus;
    bodies.at(DigitBodyIdx::left_heel_spring_id) = left_heel_spring;
    bodies.at(DigitBodyIdx::left_toe_A_id) = left_toe_A;
    bodies.at(DigitBodyIdx::left_toe_B_id) = left_toe_B;
    bodies.at(DigitBodyIdx::left_toe_pitch_id) = left_toe_pitch;
    bodies.at(DigitBodyIdx::left_toe_roll_id) = left_toe_roll;
    bodies.at(DigitBodyIdx::left_shoulder_roll_id) = left_shoulder_roll;
    bodies.at(DigitBodyIdx::left_shoulder_pitch_id) = left_shoulder_pitch;
    bodies.at(DigitBodyIdx::left_shoulder_yaw_id) = left_shoulder_yaw;
    bodies.at(DigitBodyIdx::left_elbow_id) = left_elbow;
    bodies.at(DigitBodyIdx::right_hip_roll_id) = right_hip_roll;
    bodies.at(DigitBodyIdx::right_hip_yaw_id) = right_hip_yaw;
    bodies.at(DigitBodyIdx::right_hip_pitch_id) = right_hip_pitch;
    bodies.at(DigitBodyIdx::right_knee_id) = right_knee;
    bodies.at(DigitBodyIdx::right_shin_id) = right_shin;
    bodies.at(DigitBodyIdx::right_tarsus_id) = right_tarsus;
    bodies.at(DigitBodyIdx::right_heel_spring_id) = right_heel_spring;
    bodies.at(DigitBodyIdx::right_toe_A_id) = right_toe_A;
    bodies.at(DigitBodyIdx::right_toe_B_id) = right_toe_B;
    bodies.at(DigitBodyIdx::right_toe_pitch_id) = right_toe_pitch;
    bodies.at(DigitBodyIdx::right_toe_roll_id) = right_toe_roll;
    bodies.at(DigitBodyIdx::right_shoulder_roll_id) = right_shoulder_roll;
    bodies.at(DigitBodyIdx::right_shoulder_pitch_id) = right_shoulder_pitch;
    bodies.at(DigitBodyIdx::right_shoulder_yaw_id) = right_shoulder_yaw;
    bodies.at(DigitBodyIdx::right_elbow_id) = right_elbow;
    if(num_bodies != DigitBodyIdx::total_bodies){
        std::cerr<<"num_bodies != DigitBodyIdx::total_bodies"<<std::endl;
        std::cerr<<"num_bodies: "<<num_bodies<<std::endl;
        std::cerr<<"DigitBodyIdx::total_bodies: "<<DigitBodyIdx::total_bodies<<std::endl;
    }

    // push all sites into a vector
    sites.resize(num_sites);
    sites.at(DigitSiteIdx::imu_id) = imu;
    sites.at(DigitSiteIdx::left_foot_id) = left_foot;
    sites.at(DigitSiteIdx::right_foot_id) = right_foot;
    sites.at(DigitSiteIdx::left_hand_id) = left_hand;
    sites.at(DigitSiteIdx::right_hand_id) = right_hand;
    if(num_sites != DigitSiteIdx::total_sites){
        std::cerr<<"num_sites != DigitSiteIdx::total_sites"<<std::endl;
        std::cerr<<"num_sites: "<<num_sites<<std::endl;
        std::cerr<<"DigitSiteIdx::total_sites: "<<DigitSiteIdx::total_sites<<std::endl;
    }
